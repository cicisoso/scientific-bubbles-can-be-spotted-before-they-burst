# Submission checklist: Science Research Article (19 September 2026)

Requirements digest: docs/SCIENCE_REQUIREMENTS.md (verify the live Science author pages before upload; they block automated fetches).

| Requirement | Limit / policy | This package | Status |
|---|---|---|---|
| Title | <=135 characters; declarative | "Scientific bubbles can be spotted before they burst" (51 characters) | OK |
| One-sentence summary | <=125 characters | 121 characters | OK |
| Abstract | <=125 words preferred (250 max at submission) | 124 words | OK |
| Main text | Research Article 6,000-8,000 words including references, notes and captions (verify live page) | 5,293 words incl. references and legends; 3,613 words of text | OK |
...
| References | numbered in order of citation; ~40 guideline | 29 in main text (31 incl. SM) | OK |
